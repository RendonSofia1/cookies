...
public class credenciales extends HttpServlet {
    ...
    protected void doPost(HttpServletRequest request, HttpServletResponse response)
        ...
        try {
            ...
            String sql = "INSERT INTO autentication (matricula, password)"
                    + "VALUES (?,?)";
            ...
            if (filasInsertadas > 0) {
                //Si se insertó correctamente, redirigir al usuario o a una página de exito
                ...
                //si falló, refirigir a una página de error
